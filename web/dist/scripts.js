...
const imageTemplate = jquery$1('#mb-imageTemplate');
const imageListElement = jquery$1('.mb-imageList');
...
const overlays = jquery$1('.mb-overlay');

overlays.each((i, overlay) => {
  const $overlay = jquery$1(overlay);
  $overlay.click(ev => {
...
const uploadButton = jquery$1('.mb-uploadButton');
const uploadOverlay = jquery$1('.mb-upload');
